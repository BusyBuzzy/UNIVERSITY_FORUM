...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                if (isset($_POST['create_idea'])) {
                    ...
                    //get data from the box for inserting into database
                    else {
        ...
        //                        mail function end
                ...
                <div class="h4 text-dark text-center mb-3"><img src="../img/admin_logo.png" alt=""> You can post the ideas before <i class="fas fa-calendar-alt"></i> <?php echo $academic_closure_date ?></div>
                <!-- Page Heading -->
