        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h5 mb-0 text-gray-800"><i class="fas fa-comment"></i> Anonymous Comments</h1>
                </div>

                <?php
                //for page pagination for comments section
                $per_page = 10;
                ...
                $post_query_count  =  "SELECT comment_id FROM comments WHERE comment_checkbox='anonymous'";
                ...
                if($count < 1){
                    ...
                    //the below does are for anonymous comments.
                    $select_comments = mysqli_query($connection, "SELECT * FROM comments WHERE comment_checkbox='anonymous' LIMIT $page_1, $per_page");
                ...
                <center>
                    <ul class="pager" >
                        ...
                        <?php
                        //page pagination for comment section

                        for ($i=1; $i <= $count ; $i++) {

                            if($i == $page){

                                echo "<li><a class='active_link' href='anon_comments.php?page=$i'>$i</a></li>";

                            }

                            else{

                                echo "<li><a href='anon_comments.php?page=$i'>$i</a></li>";
