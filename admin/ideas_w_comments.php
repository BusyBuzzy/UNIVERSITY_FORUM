        ...
        <div id="content">
            ...
            <div class="container-fluid" >
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray"><i class="fas fa-list-ul fa-sm"></i> Ideas without Comments</h1>
                </div>
                ...
                <div>
                    ...
                    //for ideas without comments
                    $post_query_count =  "SELECT idea_id FROM ideas WHERE idea_comment_count=0";
                    ...
                    if($count < 1){
                        ...
                        $ideas_query  =  "SELECT * FROM ideas WHERE idea_comment_count=0 LIMIT $page_1, $per_page";
                        //page paginatin end
                    ...
                    <center>
                        <ul class="pager" >
                            ...
                            for ($i=1; $i <= $count ; $i++) {
                                if($i == $page){
                                    echo "<li><a class='active_link' href='ideas_w_comments.php?page=$i'>$i</a></li> ";
                                }
                                else{
                                    echo "<li><a href='ideas_w_comments.php?page=$i'>$i</a></li> ";
                                }
                            }
                            ?>
                        </ul>
