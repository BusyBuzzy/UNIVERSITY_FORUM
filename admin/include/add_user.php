<?php
    ...
    if (isset($_POST['create_user'])) {
        ...
        else if($_POST['role_type'] == 2) {

            $select_users2   =  mysqli_query($connection, "SELECT * FROM users WHERE role_id = 2");
            $user_row_count2 =  mysqli_num_rows($select_users2);

                if ($user_row_count2 > 0) {

                    echo "<script>alert('QA Manager is already added')</script>";
        ...
        <div class="card-body">
            <form action="" method="post" class="text-dark">
                ...
                <div class="row g-3 align-items-center mb-3">
                    ...
                    <select name="role_type" id="" class="form-control">
                        ...
                        $select_roles =  mysqli_query($connection, $query);
                            ...
                            echo "<option disabled selected>Please Select Role</option>";
                ...
                <div class="col-sm-6 col-sm-offset-4 mt-4 ml-4">
                    ...
                    <input type="submit" name="create_user" Value="Create User" class="btn btn-secondary">
