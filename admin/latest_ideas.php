        ...
        <div id="content">
            ...
            <div class="container-fluid" >
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray"><i class="fas fa-list-ul fa-sm"></i> Latest Ideas</h1>
                </div>
                ...
                <div>
                    ...
                    <center>
                        <ul class="pager" >
                            ...
                            for ($i=1; $i <= $count ; $i++) {
                                if($i == $page){
                                    echo "<li><a class='active_link' href='latest_ideas.php?page=$i'>$i</a></li> ";
                                }
                                else{
                                    echo "<li><a href='latest_ideas.php?page=$i'>$i</a></li> ";
                                }
                            }
                            ?>
                        </ul>
