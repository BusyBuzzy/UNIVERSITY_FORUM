        ...
        <div id="content">
            ...
            <div class="container-fluid" >
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray"><i class="fas fa-list-ul fa-sm"></i> Most viewed Ideas</h1>
                </div>
                ...
                <div>
                    ...
                    if($count < 1){
                        ...
                        //most viewed ideas
                        $ideas_query  =  "SELECT * FROM ideas ORDER BY idea_view_count DESC LIMIT $page_1, $per_page";
                        //page paginatin end
                    ...
                    <center>
                        <ul class="pager" >
                            ...
                            for ($i=1; $i <= $count ; $i++) {
                                if($i == $page){
                                    echo "<li><a class='active_link' href='most_viewed_ideas.php?page=$i'>$i</a></li> ";
                                }
                                else{
                                    echo "<li><a href='most_viewed_ideas.php?page=$i'>$i</a></li> ";
                                }
                            }
                            ?>
                        </ul>
