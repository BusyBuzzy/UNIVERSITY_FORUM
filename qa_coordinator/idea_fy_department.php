        ...
        <div id="content">
            ...
            <div class="container-fluid" >
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray"><i class="fas fa-list-ul fa-sm"></i> Ideas from your Department</h1>
                </div>
                ...
                <div>
                    ...
                    //department ideas
                    $post_query_count =  "SELECT idea_id FROM ideas WHERE dept_id = $session_dept_id";
                    ...
                    if($count < 1){
                        ...
                        $ideas_query  =  "SELECT * FROM ideas WHERE dept_id = $session_dept_id LIMIT $page_1, $per_page";
                        //page paginatin end
                    ...
                    <center>
                        <ul class="pager" >
                            ...
                            for ($i=1; $i <= $count ; $i++) {
                                if($i == $page){
                                    echo "<li><a class='active_link' href='idea_fy_department.php?page={$i}'>{$i}</a></li> ";
                                }
                                else{
                                    echo "<li><a href='idea_fy_department.php?page={$i}'>{$i}</a></li> ";
                                }
                            }
                            ?>
                        </ul>
