        ...
        <div id="content">
            ...
            <div class="container-fluid" >
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h4 mb-0 text-gray"><i class="fas fa-list-ul fa-sm"></i> Your Ideas</h1>
                </div>
                ...
                <div>
                    ...
                    $post_query_count =  "SELECT idea_id FROM ideas WHERE user_id = $session_user_id";
                    ...
                    if($count < 1){
                        ...
                        $ideas_query  =  "SELECT * FROM ideas WHERE user_id = $session_user_id LIMIT $page_1, $per_page";
                        //page paginatin end

                        //select data from the database for showing ideas
                        ...
                        while ($row = mysqli_fetch_assoc($select_post)) {
                            ...
                            <div class="card">
                                ...
                                <div class="card-header text-white" style="background-color: #2DA491;">
                                    <div class="row">
                                ...
                                <!--like-dislike, comment and view count start-->
                    ...
                    ?>
                    <!--bottom bar pagination part-->
                    <center>
                        <ul class="pager" >
                            <?php
                            for ($i=1; $i <= $count ; $i++) {
                                if($i == $page){
                                    echo "<li><a class='active_link' href='your_idea.php?page={$i}'>{$i}</a></li> ";
                                }
                                else{
                                    echo "<li><a href='your_idea.php?page={$i}'>{$i}</a></li> ";
                                }
                            }
                            ?>
                        </ul>
