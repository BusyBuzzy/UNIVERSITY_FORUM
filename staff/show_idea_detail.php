        ...
        <div id="content">
            ...
            ?>
                ...
                <div class="container-fluid" >
                    <div class="text-center h5 mt-3 mb-3"><img src="../img/admin_logo.png" alt=""> You can comment on the ideas before <i class="fas fa-calendar-alt"></i> <?php echo $academic_f_closure_date ?> </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            if($idea_attachment == ""){
                                ...
                                <img  width="900px" height="400px" class="img-fluid img-thumbnail rounded mt-n4 mx-auto d-block" src="../images/<?php echo $idea_attachment ?>" alt="">
